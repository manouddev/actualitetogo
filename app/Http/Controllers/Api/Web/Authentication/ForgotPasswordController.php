    ...
    public function sendOtpForgotPassword(Request $request){
        ...
        if($check_email_user){
            ...
            if($check_email_user->status == 1){
                ...
                $verify_otp = OtpForgotPassword::where('visible', 1)->where('email', $datas['email'])->first();
    ...
    public function checkOtpForgotPassword(Request $request){
        ...
        if($check_email_user){
            ...
            if($check_email_user->status == 1){
                ...
                $verify_otp = OtpForgotPassword::where('visible', 1)->where('email', $datas['email'])->where('otp', $datas['otp'])->first();
