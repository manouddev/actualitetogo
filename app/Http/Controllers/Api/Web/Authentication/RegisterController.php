...
class RegisterController extends BaseController
{
    ...
    public function sendOtpRegister(Request $request){
        ...
        $check_email_user =  User::where('visible', 1)->where('email', $datas['email'])->first();
        ...
        if($check_email_user){
            ...
            if($check_email_user->status != 0){
                ...
                $verify_otp = OtpRegister::where('visible', 1)->where('email', $datas['email'])->first();
    ...
    public function checkOtpRegister(Request $request){
        ...
        if($check_email_user){
            ...
            if($check_email_user->status === 0){
                ...
                $verify_otp = OtpRegister::where('visible', 1)->where('email', $datas['email'])->where('otp', $datas['otp'])->first();
