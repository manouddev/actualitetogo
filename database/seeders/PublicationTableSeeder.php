...
use App\Models\PublicationFichier;
...
class PublicationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i = 1; $i <= 50; $i++){
            ...
            $type_publication = TypePublication::where('visible', 1)->where('slug',"article")->first();
            ...
            foreach ($posts as  $value) {
                ...
                if(isset($value['yoast_head_json']["og_image"][0]['url'])){
                    ...
                    if ($position_file !== false) {
                        ...
                        $verify_link_file = Fichier::where('visible', 1)->where('file_url', $og_file_url_file)->first();
                    ...
                    if($author->id == $value['author']){
                       ...
                       $likes_count =  rand(123,554);
                        ...
                        foreach ($value['categories'] as $wp_category) {
                            ...
                            $category =  Category::where('visible', 1)->where('wp_category_id', $wp_category)->first();

                            $publication_verify = Publication::where('visible', 1)->where('title', $value["title"]['rendered'])->count();
                            ...
                            if(isset($value['yoast_head_json']["og_image"][0]['url'])){
                                ...
                                if ($position !== false) {
                                    ...
                                    $verify_link = Fichier::where('visible', 1)->where('file_url', $og_file_url)->first();
                                    ...
                                    if($verify_link){
                                        ...
                                        $verify_date_name = InfosMonthYearPublication::where('visible', 1)->where('date_name', $date_name)->first();
