...
use App\Models\InfosMonthYearFichier;
use Carbon\Carbon;
...
class FileTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $type_files = TypeFile::where('visible', 1)->get();
                ...
                foreach( $medias as $media ){
                    ...
                    if(isset($media['source_url'])){
                        ...
                        if ($position !== false) {
                            ...
                            $verify_date_name = InfosMonthYearFichier::where('visible', 1)->where('date_name', $date_name)->first();

                            if(!$verify_date_name){

                                InfosMonthYearFichier::create(['date_name' => $date_name]);

                            }

                        
                            $fichier_original = Fichier::create([
