                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 mx-auto text-center py-4">
                                <h2 class="display-5">Rechercher un article</h2>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-9 mx-auto">
                                ...
                                <h2><i class="bi bi-symmetry-vertical me-2"></i>Articles à la une</h2>
                                                        ...
                                                        <div class="d-flex align-items-center position-relative">
                                                            <div class="avatar avatar-xs">
                                                                <div class="avatar-img rounded-circle bg-success">
                                                                    <span class="text-light position-absolute top-50 start-50 translate-middle fw-bold">{{ strtoupper($article->author_slug[0].''.$article->author_slug[1]) }}</span>
                                                                </div>
                                                            </div>

                                                            <span class="ms-3">par <a href="/auteurs/{{ $article->author_slug }}" class="stretched-link text-reset btn-link"> {{ $article->author_name }} </a></span>
                                                        </div>
                                                    </div>
                                                </li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-9 mx-auto text-center py-4">
                                ...
                                <span class="lead"> @if ($count == 0) Aucun article trouvé @elseif ($count == 1) article trouvé @else {{ $count }} articles trouvés @endif </span>
                                <!-- Search -->
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-10 mx-auto">
                                        <form class="input-group mt-4" method="GET">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-9 mx-auto">
                                ...
                                <h2><i class="bi bi-symmetry-vertical me-2"></i>@if ($count == 0) Aucun article trouvé @elseif ($count == 1) article trouvé @else {{ $count }} articles trouvés @endif </h2>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-9 text-center mx-auto my-0 my-md-5 py-0 py-lg-5 position-relative z-index-9">
                                                ...
                                                <p>Aucun article n'a été trouvé dans cette recherche</p>
