                            ...
                            <form class="mt-4">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-6">
                                            <button type="button" disabled v-if="loading" class="btn btn-success"> <i  style="color: #fff" class="fa fa-spinner fa-spin fa-1x fa-fw"></i>
                                                <span class="sr-only">Loading...</span>  Verification</button>
                                            <button type="submit"  @click.prevent="submitVerifyEmail" v-else class="btn btn-success">Verifier</button>
                                        </div>
                                ...
                                <div class="row mt-3 align-items-center">
                                    <div class="col-sm-12 text-center">
                                        <span>Si vous  disposez pas d'un compte ?&nbsp;<a href="/auth/register"><u> S'inscrire</u></a></span>
                                    </div>
                                </div>
