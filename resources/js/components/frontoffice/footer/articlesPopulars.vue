<template>
    ...
    <div v-else class="mb-4 position-relative" v-for="info in articlesPopularsData" :key="info.id">
    ...
    methods:{
       ...
       async getResults(){
            ...
            if( this.getterInfosArticlesPopularsStatus ==="success"){
                ...
                this.articlesPopularsData = this.getterInfosArticlesPopularsData
