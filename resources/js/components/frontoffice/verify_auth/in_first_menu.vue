<template>
    ...
    <span v-else-if="dataReady == 2">
        ...
        <span class="nav-link text-white" v-else-if="loadingConnect" style="cursor: pointer">Connexion en cours ...</span>
    </span>

    <span v-else-if="dataReady == 3 ">
        <span class="nav-link text-white" v-if="!loadingConnect"  @click="loginClick" style="cursor: pointer">Se connecter</span>
        <span class="nav-link text-white" v-else-if="loadingConnect" >Connexion en cours ...</span>
    </span>
...
export default {
    ...
    methods:{
      ...
      async loginClick(){
        ...
        if(localStorage.getItem('remember_me') && localStorage.getItem('username') && localStorage.getItem('password')){
