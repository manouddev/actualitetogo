    ...
    <div class="nav-item ms-2 ms-md-3 dropdown" v-else-if="dataReady === 1">
        ...
        <a class="avatar avatar-xs"  href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
            <div class="avatar-img rounded-circle bg-primary">
                ...
                <span v-else-if="meProfileRoleName === 'Visiteur'" class="text-light position-absolute top-50 start-50 translate-middle fw-bold small">{{ meProfileName[0].toUpperCase()  }}</span>
            </div>
        </a>
            ...
            <li class="px-3">
                <div class="d-flex align-items-center">
                    ...
                    <div v-else-if="meProfileRoleName === 'Visiteur' ">
                        <a class="h6 mt-2 mt-sm-0" href="#">{{meProfileName}}</a>
...
export default {
    ...
    computed: {
        ...mapGetters("meProfile",{
            ...
            gettersProfileName:'getProfileName',
            gettersProfileEmail:'getProfileEmail',
        }),
        ...mapGetters("auth", {
      ...
      async show(){
        ...
        if(localStorage.getItem('access_token') && localStorage.getItem('nbRsp')){
            ...
            if(this.gettersProfileStatus === 'success'){
                ...
                this.meProfileEmail = this.gettersProfileEmail

                this.meProfileName = this.gettersProfileName
