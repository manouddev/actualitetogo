            ...
            <div class="row px-3">
                <div class="col-12">
                    <ul class="list-inline mt-3">
                        ...
                        <li class="list-inline-item"><span style="cursor: pointer" @click="chroniques" class="btn btn-sm btn-primary-soft">CHRONIQUES</span></li>
                        <li class="list-inline-item"><span style="cursor: pointer" @click="diplomatie" class="btn btn-sm btn-success-soft">DIPLOMATIE</span></li>
                    </ul>
                </div>
            </div> <!-- Row END -->
        </div>
...
export default {
    ...
    methods:{
       ...
       async getResults(){
        ...
        diplomatie(){
            window.location = '/diplomatie'
        },

        chroniques(){
            window.location = '/chroniques'
        },
    },
