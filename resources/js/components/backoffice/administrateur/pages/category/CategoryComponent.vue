<template>
                                ...
                                <div class="row g-3 align-items-center justify-content-between">
                                    ...
                                    <div class="col-md-10">
                                        <form class="rounded position-relative" method="GET" @submit.prevent="getResults">
                                            <input class="form-control bg-transparent" v-model="search" @input="show" name="search" type="text" placeholder="Rechercher une catégorie ..." aria-label="Search">
    ...
    <!-- Modal Form -->
    <div class="modal fade" id="authFormModalCategoryList" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" v-if="authSectionModal == 'CREATE'">
                <div class="modal-header">
                    <h5 class="modal-title">Ajouter une catégorie</h5>
                    <button type="button" class="btn-close" @click="authFormModalCategoryListClose" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form>
                    <div class="modal-body">
                        ...
                        <div class="mb-3" v-if="categoryStoreErrors.name">
                            <label class="form-label" for="exampleInputEmailCategoryCreate">Nom de la catégorie</label>
                            <input type="text" v-model="name" name="name" class="form-control is-invalid" id="exampleInputEmailCategoryCreate" placeholder="Entrez le nom de la catégorie">
                            <div v-for="errorname in categoryStoreErrors.name" :key="errorname" class="invalid-feedback">
                                {{ errorname }}
                            </div>
                        </div>
                        <div class="mb-3" v-else>
                            <label class="form-label" for="exampleInputEmailLoginInvalid">Nom de la catégorie</label>
                            <input type="text" v-model="name" name="name" class="form-control" id="exampleInputEmailCategoryCreate" placeholder="Entrez le nom de la catégorie">
                        </div>
                    </div>
                    <div class="modal-footer" >
                        <div  v-if="!loadingCreate" style="margin-top: -5px; margin-bottom: -10px">
                            ...
                            &nbsp;
                            <span><span class="btn btn-danger" @click="authFormModalCategoryListClose">Fermez</span></span>
                        </div>
            ...
            <div class="modal-content" v-if="authSectionModal == 'DELETE'">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <p class="text-center">Toutes données relatives à cette catégorie seront aussi supprimées.</p>
                    </div>
                    <div class="d-flex justify-content-center" v-if="!loadingDelete" style="margin-top: -5px; margin-bottom: -10px">
                        ...
                        &nbsp;
                        <span><span class="btn btn-success" @click="authFormModalCategoryListClose">Annuler</span></span>
                    </div>
...
export default {
    ...
    computed: {
        ...
        ...mapGetters('categoryAdmin',{
            ...
            getterInfosCategoryUpdateStatus:'getInfosCategoryUpdateStatus',
            getterInfosCategoryUpdateMessage:'getInfosCategoryUpdateMessage',
            getterInfosCategoryUpdateErrors:'getInfosCategoryUpdateErrors',
            getterInfosCategoryUpdateData:'getInfosCategoryUpdateData',
            getterInfosCategoryDeleteStatus:'getInfosCategoryDeleteStatus',
            getterInfosCategoryDeleteMessage:'getInfosCategoryDeleteMessage',
            getterInfosCategoryDeleteData:'getInfosCategoryDeleteData',
        }),
        ...mapGetters('login',{
    ...
    methods:{
        ...
        ...mapActions("categoryAdmin",{
          ...
          actionsCategoryUpdateDataRequest:'categoryUpdateDataRequest',
          actionsCategoryDeleteDataRequest:'categoryDeleteDataRequest'
        }),


        authFormModalCategoryListClose(){
            ...
            this.errorsLogin = []
            this.categoryUpdateMessage =  null
            this.categoryUpdateErrors = []
            this.categoryStoreMessage =  null
            this.categoryStoreErrors = []
            $('#authFormModalCategoryList').modal('hide');
        },
        ...
        authModalClick(action_auth="LIST", name=null, slug=null){
            ...
            $('#authFormModalCategoryList').modal('show');
        },
            ...
            if(this.getterLoginStatus === 'success admin'){
                ...
                if(this.remember_me){
                    ...
                    if(this.authSectionModal== 'LIST'){
                        ...
                        this.authFormModalCategoryListClose()
        ...
        async getResults(page = 1){
            ...
            await this.actionsCategoryListDataRequest({ page : page, search: this.search});

            if( this.getterInfosCategoryListStatus ==="success"){

                this.categoryListData = this.getterInfosCategoryListData
            ...
            }else if( this.getterInfosCategoryListStatus ==="empty"){

                this.categoryListMessage = this.getterInfosCategoryListMessage
            ...
            }else if(this.getterInfosCategoryListStatus === 'failed'){
        ...
        async categoryCreate(){
            ...
            await this.actionsCategoryStoreDataRequest({ name : this.name});

            if( this.getterInfosCategoryStoreStatus ==="success"){

                this.categoryStoreData = this.getterInfosCategoryStoreData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosCategoryStoreMessage
                })
            ...
            }else if( this.getterInfosCategoryStoreStatus ==="empty"){

                this.categoryStoreMessage = this.getterInfosCategoryStoreMessage
            ...
            }else if( this.getterInfosCategoryStoreStatus ==="error"){

                this.categoryStoreMessage = this.getterInfosCategoryStoreMessage

                this.categoryStoreErrors = this.getterInfosCategoryStoreErrors
        ...
        async categoryUpdate(){
            ...
            await this.actionsCategoryUpdateDataRequest({ name : this.name, slug : this.slug,});

            if( this.getterInfosCategoryUpdateStatus ==="success"){

                this.categoryUpdateData = this.getterInfosCategoryUpdateData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosCategoryUpdateMessage
                })
            ...
            }else if( this.getterInfosCategoryUpdateStatus ==="empty"){

                this.categoryUpdateMessage = this.getterInfosCategoryUpdateMessage

                this.categoryUpdateErrors = this.getterInfosCategoryUpdateErrors

                this.loadingUpdate = false


            }else if( this.getterInfosCategoryUpdateStatus ==="error"){
        ...
        async categoryDelete(){
            ...
            await this.actionsCategoryDeleteDataRequest({slug : this.slug});

            if( this.getterInfosCategoryDeleteStatus ==="success"){

                this.categoryDeleteData = this.getterInfosCategoryDeleteData
                ...
                Toast.fire({
                    icon: 'success',
                    title: this.getterInfosCategoryDeleteMessage
                })
            ...
            }else if( this.getterInfosCategoryDeleteStatus ==="empty"){

                this.categoryDeleteMessage = this.getterInfosCategoryDeleteMessage

                this.categoryDeleteErrors = this.getterInfosCategoryDeleteErrors

                this.loadingDelete = false


            }else if( this.getterInfosCategoryDeleteStatus ==="error"){
