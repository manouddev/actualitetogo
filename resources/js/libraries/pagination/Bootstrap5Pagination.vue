   ...
   <RenderlessPagination
    ...
    >
        <ul
            ...
            <li class="page-item " :class="{'disabled': !slotProps.computed.prevPageUrl}" v-if="slotProps.computed.prevPageUrl || showDisabled">
            ...
            <li class="page-item" v-for="(page, key) in slotProps.computed.pageRange" :key="key" :class="{ 'active': page == slotProps.computed.currentPage }">
