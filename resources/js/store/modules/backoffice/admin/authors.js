...
const actions = {
    async authorsListDataRequest({ commit }, payload) {
        const response = await jwtInterceptor.get(`backoffice/admin/authors_list?page=${payload.page}&search=${payload.search}`).catch((err) => { console.log(err);});
    ...
    async authorsListHDataRequest({ commit }, payload) {
        const response = await jwtInterceptor.get(`backoffice/admin/authors_search_by_user_infos?page=${payload.page}&user_id=${payload.user_id}`).catch((err) => { console.log(err);});
        if (response && (response.data.data.status == 200)) {
            commit("setInfosAuthorsListStatus", "success");
            commit("setInfosAuthorsListMessage", response.data.message);
            commit("setInfosAuthorsListData", response.data.data);
    ...
    async searchByUserListDataRequest({ commit }, payload) {
        const response = await jwtInterceptor.get(`backoffice/admin/authors_search_by_user`).catch((err) => { console.log(err);});
        if (response && (response.data.data.status == 200)) {
    ...
    async authorsShowDataRequest({ commit }, payload) {
        const response = await jwtInterceptor.get(`backoffice/admin/${payload.slug}/authors_show`, payload).catch((err) => { console.log(err);});
        if (response && (response.data.data.status == 200)) {
    ...
    async authorsStoreDataRequest({ commit },  payload) {
        const response = await jwtInterceptor.post("backoffice/admin/authors_store", payload).catch((err) => { console.log(err);});
        if (response && (response.data.data.status == 200)) {
    ...
    async authorsUpdateDataRequest({ commit },  payload) {
        const response = await jwtInterceptor.put(`backoffice/admin/${payload.slug}/authors_update`, payload).catch((err) => { console.log(err);});
        if (response && (response.data.data.status == 200)) {
    ...
    async authorsDeleteDataRequest({ commit }, payload) {
        const response = await jwtInterceptor.delete(`backoffice/admin/${payload.slug}/authors_delete`).catch((err) => { console.log(err);});
        if (response && (response.data.data.status == 200)) {
